...
def parse_args():
    ...
    parser.add_argument('--action_feat', dest='action_feat',
                        help='Use relative location feature or not',
                        type=ast.literal_eval, default=True)

    parser.add_argument('--spatial_feat', dest='spatial_feat',
                        help='Use relative location feature or not',
                        type=ast.literal_eval, default=True)

    parser.add_argument('--image_feat', dest='image_feat',
                        help='Use relative location feature or not',
                        type=ast.literal_eval, default=True)
    parser.add_argument('--pos_feat', dest='pos_feat',
                        help='Use relative location feature or not',
                        type=ast.literal_eval, default=True)                    
    parser.add_argument('--aclip_feat', dest='aclip_feat',
                        help='Use relative location feature or not',
                        type=ast.literal_eval, default=True)
