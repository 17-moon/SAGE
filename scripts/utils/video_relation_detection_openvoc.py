...
def eval_relation_detection_openvoc(
    ...
    enti_cls_split_info_path="/home/xwy/MMP/dataset/vidvrd/data/openvoc_obj_class_spilt_info.json",
    pred_cls_split_info_path="/home/xwy/MMP/dataset/vidvrd/data/openvoc_pred_class_spilt_info.json",
    prediction_results=None,
    json_results_path=None,
    gt_json="/home/xwy/MMP/dataset/vidvrd/data/test_relation_gt.json",
    rt_hit_infos = False,
):
    '''
