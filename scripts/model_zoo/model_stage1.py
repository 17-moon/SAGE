...
class Model(nn.Module):
    ...
    def __init__(self, args):
        ...
        # self.adapter=Adapter(2048,8)
        # self.adapter_img=Adapter(2048,8)
    ...
    def get_text_embeddings(self):
        return self.split_text_embeddings(split=self.tgt_split)[0]
    ...
    def forward(self, inputs, seq_lens, labels=None):
        ...
        if not self.training:
            ...
            # x = self.adapter(text_pre_embeddings)

            # ratio = 0.2
            # text_pre_embeddings = ratio * x + (1 - ratio) * text_pre_embeddings
